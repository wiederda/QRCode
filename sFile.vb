...
Public Class s_File
  ...
  (ByVal lpExistingFileName As String, ByVal lpNewFileName As String,
   ByVal dwFlags As Long) As Boolean
    ...
    Public Function OpenFileDialog(IniPfad As String, Filter As String, DefaultExt As String) As String
    ...
    ''' <param name="IniPfad">...</param>
    ''' <param name="Filter">....</param>
    Public Function SaveFileDialog(IniPfad As String, Filter As String, DefaultExt As String) As String
